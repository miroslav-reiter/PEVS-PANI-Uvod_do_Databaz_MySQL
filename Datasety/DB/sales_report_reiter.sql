-- -------------------------------------
-- CSV Lint plug-in v0.4.5.4
-- File: Sales_Report.csv
-- Date: 11-mar-2023 09:33
-- SQL type: mySQL
-- -------------------------------------
CREATE TABLE t_sales_report_reiter (
	`_record_number` int AUTO_INCREMENT NOT NULL,
	`Výrobok` varchar(32),
	`Zákazník` varchar(5),
	`1. štvrťrok` varchar(10),
	`2. štvrťrok` varchar(10),
	`3. štvrťrok` varchar(10),
	`4. štvrťrok` varchar(10),
	primary key(`_record_number`)
);

-- -------------------------------------
-- insert records 1 - 277
-- -------------------------------------
insert into t_sales_report_reiter (
	`Výrobok`,
	`Zákazník`,
	`1. štvrťrok`,
	`2. štvrťrok`,
...
('Alica Kopcová', 'ANTON', '-   €', '702,00 €', '-   €', '-   €'),
('Alica Kopcová', 'BERGS', '312,00 €', '-   €', '-   €', '-   €'),
('Alica Kopcová', 'BOLID', '-   €', '-   €', '-   €', '1 170,00 €'),
('Alica Kopcová', 'BOTTM', '1 170,00 €', '-   €', '-   €', '-   €'),
('Alica Kopcová', 'ERNSH', '1 123,20 €', '-   €', '-   €', '2 607,15 €'),
('Alica Kopcová', 'GODOS', '-   €', '280,80 €', '-   €', '-   €'),
('Alica Kopcová', 'HUNGC', '62,40 €', '-   €', '-   €', '-   €'),
('Alica Kopcová', 'PICCO', '-   €', '1 560,00 €', '936,00 €', '-   €'),
('Alica Kopcová', 'RATTC', '-   €', '592,80 €', '-   €', '-   €'),
('Alica Kopcová', 'REGGC', '-   €', '-   €', '-   €', '741,00 €'),
('Alica Kopcová', 'SAVEA', '-   €', '-   €', '3 900,00 €', '789,75 €'),
('Alica Kopcová', 'SEVES', '-   €', '877,50 €', '-   €', '-   €'),
('Alica Kopcová', 'WHITC', '-   €', '-   €', '-   €', '780,00 €'),
